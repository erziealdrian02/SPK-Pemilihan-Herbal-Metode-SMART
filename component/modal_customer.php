...
<!-- User Modal -->
<div id="open-customer-add" class="modal-window">
    <div>
        <a href="#" title="Close" class="modal-close">Close</a>
...
<div id="open-customer-edit<?php echo $data['consumer_id']; ?>" class="modal-window">
    <div>
        <a href="#" title="Close" class="modal-close">Close</a>
        <h1>Form Input Pelanggan</h1>
        <form id="diagnosa-form-edit-<?php echo $data['consumer_id']; ?>" action="./proses/edit_customer.php" method="post" enctype="multipart/form-data" role="form">
            <div class="formBody row">
                <div class="column s-12">
                    <label class="inputGroup">
                        <span>Nama</span>
                    ...
                    <label class="inputGroup">
                        <span>Email</span>
                        <span><input type="text" name="email" value="<?php echo $data['email']; ?>" /></span>
                    </label>
                    <input type="hidden" name="consumer_id" value="<?php echo $data['consumer_id']; ?>" />
                </div>
            </div>
            <button type="submit" name="submit">Submit</button>
        </form>
